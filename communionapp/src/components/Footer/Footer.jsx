...
import message from "./icons/comments.png"
  ...
  const Footer = ()=>{
    ...
    <Link to="/events" className="links-components"> <div className="img-contain"> events</div></Link>
    <Link to="/events" className="links-components"><div className="img-contain"> add event </div></Link>
